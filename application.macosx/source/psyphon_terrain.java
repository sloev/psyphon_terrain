...
public class psyphon_terrain extends PApplet {
...
colorMode(RGB,255);
  ...
  rots+=0.01f;
  rots2+=0.001f;
  float a=sin(rots)*0.01f;
  float b=(sin(rots)*0.01f+cos(rots2)*0.01f-sin(rots2/3+rots/3)*0.01f)/3;
  cam.rotateViewBy(b);
  cam.turnBy(b);
...
public PVector getRandomVelocity(float speed) {
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--bgcolor=#FFFFFF", "psyphon_terrain" });
  }
}
